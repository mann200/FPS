...
// End Cross Module References
	DEFINE_FUNCTION(UMySqlSubSystem::execLuaCreateNewMySqlConnection)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		*(UMySqlObject**)Z_Param__Result=P_THIS->LuaCreateNewMySqlConnection(Z_Param_Server,Z_Param_DBName,Z_Param_UserID,Z_Param_Password,Z_Param_ExtraParams);
		P_NATIVE_END;
	}
	...
	void UMySqlSubSystem::StaticRegisterNativesUMySqlSubSystem()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "LuaCreateNewMySqlConnection", &UMySqlSubSystem::execLuaCreateNewMySqlConnection },
	...
	struct Z_Construct_UFunction_UMySqlSubSystem_LuaCreateNewMySqlConnection_Statics
	{
		struct MySqlSubSystem_eventLuaCreateNewMySqlConnection_Parms
		{
			FString Server;
			FString DBName;
			FString UserID;
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMySqlSubSystem_LuaCreateNewMySqlConnection_Statics::NewProp_Server = { "Server", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MySqlSubSystem_eventLuaCreateNewMySqlConnection_Parms, Server), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMySqlSubSystem_LuaCreateNewMySqlConnection_Statics::NewProp_DBName = { "DBName", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MySqlSubSystem_eventLuaCreateNewMySqlConnection_Parms, DBName), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMySqlSubSystem_LuaCreateNewMySqlConnection_Statics::NewProp_UserID = { "UserID", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MySqlSubSystem_eventLuaCreateNewMySqlConnection_Parms, UserID), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMySqlSubSystem_LuaCreateNewMySqlConnection_Statics::NewProp_Password = { "Password", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MySqlSubSystem_eventLuaCreateNewMySqlConnection_Parms, Password), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMySqlSubSystem_LuaCreateNewMySqlConnection_Statics::NewProp_ExtraParams_ValueProp = { "ExtraParams", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, 1, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMySqlSubSystem_LuaCreateNewMySqlConnection_Statics::NewProp_ExtraParams_Key_KeyProp = { "ExtraParams_Key", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UFunction_UMySqlSubSystem_LuaCreateNewMySqlConnection_Statics::NewProp_ExtraParams = { "ExtraParams", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MySqlSubSystem_eventLuaCreateNewMySqlConnection_Parms, ExtraParams), EMapPropertyFlags::None, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMySqlSubSystem_LuaCreateNewMySqlConnection_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MySqlSubSystem_eventLuaCreateNewMySqlConnection_Parms, ReturnValue), Z_Construct_UClass_UMySqlObject_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UMySqlSubSystem_LuaCreateNewMySqlConnection_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMySqlSubSystem_LuaCreateNewMySqlConnection_Statics::NewProp_Server,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMySqlSubSystem_LuaCreateNewMySqlConnection_Statics::NewProp_DBName,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMySqlSubSystem_LuaCreateNewMySqlConnection_Statics::NewProp_UserID,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMySqlSubSystem_LuaCreateNewMySqlConnection_Statics::NewProp_Password,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMySqlSubSystem_LuaCreateNewMySqlConnection_Statics::NewProp_ExtraParams_ValueProp,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMySqlSubSystem_LuaCreateNewMySqlConnection_Statics::NewProp_ExtraParams_Key_KeyProp,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMySqlSubSystem_LuaCreateNewMySqlConnection_Statics::NewProp_ExtraParams,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMySqlSubSystem_LuaCreateNewMySqlConnection_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UMySqlSubSystem_LuaCreateNewMySqlConnection_Statics::Function_MetaDataParams[] = {
		{ "Category", "MySql|Subsystem" },
		{ "DisplayName", "Create MySql New Connection" },
		{ "ModuleRelativePath", "Public/MySqlCore/MySqlSubSystem.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMySqlSubSystem_LuaCreateNewMySqlConnection_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMySqlSubSystem, nullptr, "LuaCreateNewMySqlConnection", nullptr, nullptr, sizeof(Z_Construct_UFunction_UMySqlSubSystem_LuaCreateNewMySqlConnection_Statics::MySqlSubSystem_eventLuaCreateNewMySqlConnection_Parms), Z_Construct_UFunction_UMySqlSubSystem_LuaCreateNewMySqlConnection_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMySqlSubSystem_LuaCreateNewMySqlConnection_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UMySqlSubSystem_LuaCreateNewMySqlConnection_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UMySqlSubSystem_LuaCreateNewMySqlConnection_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UMySqlSubSystem_LuaCreateNewMySqlConnection()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UMySqlSubSystem_LuaCreateNewMySqlConnection_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMySqlSubSystem_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UMySqlSubSystem_LuaCreateNewMySqlConnection, "LuaCreateNewMySqlConnection" }, // 2470764008
	...
	struct Z_CompiledInDeferFile_FID_MultiFPSTeach_Plugins_FJQMySql_Source_FJQMySql_Public_MySqlCore_MySqlSubSystem_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MultiFPSTeach_Plugins_FJQMySql_Source_FJQMySql_Public_MySqlCore_MySqlSubSystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMySqlSubSystem, UMySqlSubSystem::StaticClass, TEXT("UMySqlSubSystem"), &Z_Registration_Info_UClass_UMySqlSubSystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMySqlSubSystem), 2791875372U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MultiFPSTeach_Plugins_FJQMySql_Source_FJQMySql_Public_MySqlCore_MySqlSubSystem_h_2544184332(TEXT("/Script/FJQMySql"),
		Z_CompiledInDeferFile_FID_MultiFPSTeach_Plugins_FJQMySql_Source_FJQMySql_Public_MySqlCore_MySqlSubSystem_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MultiFPSTeach_Plugins_FJQMySql_Source_FJQMySql_Public_MySqlCore_MySqlSubSystem_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
