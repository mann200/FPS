...
// End Cross Module References
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_SeleteImageDelegate_MetaData[];
#endif
		static const UECodeGen_Private::FMulticastDelegatePropertyParams NewProp_SeleteImageDelegate;
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMySqlObject_Statics::NewProp_SeleteImageDelegate_MetaData[] = {
		{ "ModuleRelativePath", "Public/MySqlCore/MySqlObject.h" },
	};
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UMySqlObject_Statics::NewProp_SeleteImageDelegate = { "SeleteImageDelegate", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMySqlObject, SeleteImageDelegate), Z_Construct_UDelegateFunction_FJQMySql_SeleteImageFromQueryDelegate__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UMySqlObject_Statics::NewProp_SeleteImageDelegate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMySqlObject_Statics::NewProp_SeleteImageDelegate_MetaData)) }; // 3497322867
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UMySqlObject_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UMySqlObject_Statics::NewProp_SeleteImageDelegate,
	};
	...
	struct Z_CompiledInDeferFile_FID_MultiFPSTeach_Plugins_FJQMySql_Source_FJQMySql_Public_MySqlCore_MySqlObject_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MultiFPSTeach_Plugins_FJQMySql_Source_FJQMySql_Public_MySqlCore_MySqlObject_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMySqlObject, UMySqlObject::StaticClass, TEXT("UMySqlObject"), &Z_Registration_Info_UClass_UMySqlObject, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMySqlObject), 1094382245U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MultiFPSTeach_Plugins_FJQMySql_Source_FJQMySql_Public_MySqlCore_MySqlObject_h_84030195(TEXT("/Script/FJQMySql"),
		Z_CompiledInDeferFile_FID_MultiFPSTeach_Plugins_FJQMySql_Source_FJQMySql_Public_MySqlCore_MySqlObject_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MultiFPSTeach_Plugins_FJQMySql_Source_FJQMySql_Public_MySqlCore_MySqlObject_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
